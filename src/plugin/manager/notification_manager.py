...
class NotificationManager(BaseManager):
    ...
    def dispatch(self, token_mgr: TokenManager, bot_id: str, channel_id: str, message: dict,
        ...
        naver_works_connector.send_message(bot_id, channel_id, message_manager.message, headers)
